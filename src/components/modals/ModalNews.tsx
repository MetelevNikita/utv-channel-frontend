...
const ModalNews: FC<ModalNewsProps>  = ({ modalMessage }) => {
  ...
  return (
    ...
    <Col lg={12} md={12} sm={12} xs={12} style={{width: '100%', height: '100vh', backgroundColor: '#21252947', position: 'fixed', top: '0px'}}>
      ...
      <Col style={{width: '489px', height: '753px', backgroundColor: 'white', position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', borderRadius: '8px'}}>

      <Col md={12} sm={12} className='d-flex flex-column justify-content-center align-items-center mt-4'>

            <Col lg={12} md={12} sm={12} className='d-flex justify-content-center mb-4'><img src={modalImg} alt="modal-img" /></Col>
            ...
            <Col lg={12} md={12} sm={12} className='d-flex justify-content-center align-items-center mb-3'><MyTextArea onChange={() => {}} value={''} cols={14} rows={5} style={{paddingLeft: '10px', border: '1px solid #D1D1D1', borderRadius: '8px', width: '90%', height: '137px', paddingTop: '10px'}} placeholder='текст'></MyTextArea></Col>
